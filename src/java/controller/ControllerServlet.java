...
//         getServletContext().setAttribute("categories1", categoryFacade.find(1));
    }
...
//                    String sel = categoryFacade.find(Short.parseShort(cat));
        ...
        if (userPath.equals("/aboutUs")) {
            userPath = "/about_us";
        }
         if (userPath.equals("/contactUs")) {
            userPath = "/contact_us";
        }
            // if checkout page is requested

        // use RequestDispatcher to forward request internally
        String url = "/WEB-INF/customer" + userPath + ".jsp";
