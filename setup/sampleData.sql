...
--
INSERT INTO `category` (name) VALUES ('cookers'),('dishwashers'),('fridges'),('microwaves');


--
-- Sample data for table `product`
--
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('burners', 1.70, 'c', 1);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('buttons', 2.39, 'c', 1);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('doors', 1.09, 'c', 1);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('elements', 1.76, 'c', 1);

INSERT INTO `product` (`name`, price, description, category_id) VALUES ('fascias', 2.29, 'd', 2);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('filters', 3.49, 'd', 2);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('hinges', 2.59, 'd', 2);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('hoses', 3.55, 'd', 2);

INSERT INTO `product` (`name`, price, description, category_id) VALUES ('motor', 1.89, 'f', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('seals', 1.19, 'f', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('shelves', 1.15, 'f', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('thermostats', 2.39, 'f', 3);

INSERT INTO `product` (`name`, price, description, category_id) VALUES ('coupling', 1.59, 'm', 4);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('lamps', 2.49, 'm', 4);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('motors', 1.29, 'f', 4);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('glass turntables', 1.49, 'f', 4);
